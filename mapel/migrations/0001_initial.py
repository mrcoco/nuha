    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tahun', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='tahunajaran.TahunAjaran', verbose_name='Tahun Ajaran')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('kelas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jurusan.Kelas', verbose_name='Kelas')),
                ('mapel', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='mapel.Mengajar', verbose_name='Mata Pelajaran')),
